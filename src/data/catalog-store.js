...
const seedProviders = [
  ...
  },
  {
    ...
    name: 'DeepSeek',
    vendor: 'DeepSeek',
    description: 'DeepSeek API con endpoint Anthropic-compatible oficial. Claude Connect usa V4 Flash y V4 Pro, y puede descubrir modelos vigentes desde /models.',
    docsUrl: 'https://api-docs.deepseek.com/',
    docsVerifiedAt: '2026-04-24',
    ...
    models: [
      {
        ...
        category: 'General',
        contextWindow: '1M',
        summary: 'Modelo actual de DeepSeek para uso general y coding con thinking por defecto y tool calls.',
      ...
      },
      {
        ...
        category: 'Reasoning',
        contextWindow: '1M',
        summary: 'Modelo mas capaz de DeepSeek para razonamiento y agentes, con thinking por defecto y tool calls.',
  ...
  },
  {
    ...
    name: 'Google Gemini',
    vendor: 'Google',
    description: 'Gemini API por API key usando el endpoint OpenAI-compatible oficial de Google. Claude Code se conecta a traves del gateway local para mantener compatibilidad Anthropic, herramientas, vision y reasoning.',
    docsUrl: 'https://ai.google.dev/gemini-api/docs/openai',
    docsVerifiedAt: '2026-04-21',
    ...
    models: [
      {
        ...
        category: 'Google OpenAI-compatible',
        contextWindow: '1M',
        summary: 'Modelo Gemini 3 mas capaz para razonamiento, multimodalidad, herramientas y coding agentico.',
      ...
      },
      {
        ...
        category: 'Google OpenAI-compatible',
        contextWindow: '1M',
        summary: 'Modelo Gemini 3 balanceado para velocidad, escala, multimodalidad y razonamiento.',
      ...
      },
      {
        ...
        category: 'Google OpenAI-compatible',
        contextWindow: '1M',
        summary: 'Modelo estable de pensamiento avanzado para codigo, STEM, documentos largos y multimodalidad.',
      ...
      },
      {
        ...
        category: 'Google OpenAI-compatible',
        contextWindow: '1M',
        summary: 'Modelo estable de buen balance precio/rendimiento con thinking, herramientas y vision.',
      ...
      },
      {
        ...
        category: 'Google OpenAI-compatible',
        contextWindow: '1M',
        summary: 'Modelo Gemini ligero para bajo costo y baja latencia con soporte multimodal y herramientas.',
        upstreamModelId: 'gemini-2.5-flash-lite-preview-09-2025',
        transportMode: 'gateway',
        apiStyle: 'openai-chat',
        apiBaseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai',
        apiPath: '/chat/completions',
    ...
    authMethods: [
      {
        id: 'token',
        name: 'Token',
        description: 'Conexion por GEMINI_API_KEY contra el endpoint OpenAI-compatible oficial de Google.',
        credentialKind: 'env_var',
        sortOrder: 1,
        isDefault: 1
      }
  ...
  },
  {
    ...
    vendor: 'Cloudflare',
    description: 'Workers AI usando API token y Account ID de Cloudflare. Claude Code se conecta a traves del gateway local hacia el endpoint OpenAI-compatible oficial.',
    docsUrl: 'https://developers.cloudflare.com/workers-ai/configuration/open-ai-compatibility/',
    docsVerifiedAt: '2026-04-22',
    baseUrl: 'https://api.cloudflare.com/client/v4',
    defaultModelId: null,
    defaultAuthMethodId: 'token',
    defaultApiKeyEnvVar: 'CLOUDFLARE_API_TOKEN',
    models: [],
    authMethods: [
      {
        id: 'token',
        name: 'Token',
        description: 'Conexion por CLOUDFLARE_API_TOKEN y Account ID. Requiere permisos Workers AI Read o Edit.',
        credentialKind: 'env_var',
        sortOrder: 1,
        isDefault: 1
      }
